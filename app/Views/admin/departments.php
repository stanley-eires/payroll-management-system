            ...
            <table class="table datatable">
                <thead class="">
                    <tr>
                        ...
                        <th class='text-nowrap'>Department Manager</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class='h6'><?=$key['department']?></a>
                            <div class="contextual-menu">
                                <a href="#" class='small'>Edit</a>
                            </div>
                            
                        </td>
                        <td><?=$key['dpt_manager']?></td>
                        <td class=''><?=$key['no_employees']?></td>
                    </tr>
                    <?php endforeach?>
                </tbody>
            </table>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="my-modal-title">New Department</h5>
